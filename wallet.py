...
class AcademicWallet:
    ...
    def verify_signature(self, certificate_data: Dict, signature_hex: str, public_key_pem: str = None) -> bool:
        try:
            if public_key_pem:
    ...
    def create_signed_certificate(self, student_name: str, student_id: str, 
                                 ...
                                 issue_date: str) -> Dict:
        """Create and sign a certificate for a student"""
        certificate = {
        ...
        # Return signed certificate with hash and signature
        signed_cert = certificate.copy()
        signed_cert["signature"] = signature
        signed_cert["public_key"] = self.get_public_key_pem()
        signed_cert["cert_hash"] = cert_hash
        signed_cert["status"] = "active"
...
class WalletManager:
    ...
    def create_wallet(self, user_type: str = "institution") -> Optional[AcademicWallet]:
